  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative flex h-14 w-14 items-center justify-center border-y border-r border-input text-xl shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md',
